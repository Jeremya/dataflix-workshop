...
public class VideoTest extends AbstractDSETest {
    ...
    private LatestVideo findVideoWithID(Iterable<LatestVideo> videos, UUID videoID)
    {
        for(LatestVideo video : videos)
    ...
    public void testUpdateDeleteGetLatestVideos() throws VideoAlreadyExistsException {
        ...
        Iterable<LatestVideo> latestVideos = videoDAO.getLatestVideos();
        LatestVideo fromLatest = findVideoWithID(latestVideos, copy.getVideoId());
