...
public class VideoService {
    ...
    public Response getRecentVideos() throws IOException {
        ...
        List<LatestVideo> allVideos = Lists.newArrayList(videos);
    ...
    @GET
    @Path("genre/{genre}/{mindate}/{maxdate}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getVideosByGenre(@PathParam("genre") String genre, @PathParam("mindate") Integer mindate, @PathParam("maxdate") Integer maxdate) throws IOException {

        Iterable<VideoByGenre> videos = videoDAO.getVideosByGenre(genre, mindate, maxdate);

        List<VideoByGenre> allVideos = Lists.newArrayList(videos);
