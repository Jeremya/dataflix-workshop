(function () {
    ...
    var videoFactory = function ($http, $location, $log) {
        ...
        //Retrieves a list of all videos based on a genre
        factory.getVideosByGenre = function(genre, mindate, maxdate) {
            return $http.get(API_PREFIX+'videos/genre/'+genre+ '/' +mindate+ '/' +maxdate);
        }
