...
(function () {
    ...
    app.config(function ($routeProvider) {
        ...
        $routeProvider
            ...
            .when('/topvideos', buildRoute('TopVideosController', 'app/views/topvideos.html', false))
            .when('/topvideos/:genre?', buildRoute('TopVideosController', 'app/views/topvideos.html', false))
            .when('/topvideos/:genre?/:mindate?/:maxdate?', buildRoute('TopVideosController', 'app/views/topvideos.html', false))
            .when('/oops', {
